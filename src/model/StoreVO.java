...
public class StoreVO {
	...
	// 매장코드와 비밀번호만 받는 생성자
	public StoreVO(String s_code, int s_pw) {
		super();
		this.s_code = s_code;
		this.s_pw = s_pw;
	}
	// 매장코드를 제외하고 받는 생성자
	public StoreVO(String s_address, String s_name, int s_pw, int s_phonenumber) {
		super();
	...
	// 전체 필드 생성자
		public StoreVO(String s_code, String s_address, String s_name, int s_pw, int s_phonenumber) {
			super();
			this.s_code = s_code;
			this.s_address = s_address;
			this.s_name = s_name;
